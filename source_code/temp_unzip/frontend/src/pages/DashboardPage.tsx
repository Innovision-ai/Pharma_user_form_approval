  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        {CARDS.map((card) => <MetricCard key={card.key} label={card.label} value={summary[card.key as keyof DashboardSummary] as number} tone={card.tone} icon={card.icon} trend={card.trend} />)}
      </div>
      <Card>
